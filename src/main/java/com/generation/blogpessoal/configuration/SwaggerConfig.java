    ...
    OpenAPI springBlogPessoalOpenAPI() { 
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Blog Pessoal - Jamila Moraes Cardoso")
                .version("v0.0.1")
                .license(new License()
                    .name("InovaHer")
                    .url("https://github.com/InovaHer"))
                .contact(new Contact()
                    .name("Jamila M. Cardoso")
                    .url("https://github.com/jmcardoso18/blogpessoal_spring")
                    .email("jmc18.ads@gmail.com")))
            .externalDocs(new ExternalDocumentation()
                .description("Github Jamila")
